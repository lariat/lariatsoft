...
public :
   ...
   Int_t           nAG;
   Double_t        HitTimeStampUSE[1];   //[nAG]
   ...
   TBranch        *b_nAG;   //!
   TBranch        *b_HitTimeStampUSE;   //!
   TBranch        *b_HitTimeStampUSW;   //!
   TBranch        *b_HitTimeStampDS1;   //!
   TBranch        *b_HitTimeStampDS2;   //!
   TBranch        *b_HitPulseAreaUSE;   //!
   TBranch        *b_HitPulseAreaUSW;   //!
   TBranch        *b_HitPulseAreaDS1;   //!
   TBranch        *b_HitPulseAreaDS2;   //!
   TBranch        *b_HitExistUSE;   //!
   TBranch        *b_HitExistUSW;   //!
   TBranch        *b_HitExistDS1;   //!
   TBranch        *b_HitExistDS2;   //!
...
void ProtonEnergyCorrections::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("trkWCtoTPCMath", &trkWCtoTPCMath, &b_trkWCtoTPCMath);
