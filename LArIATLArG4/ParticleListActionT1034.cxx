////////////////////////////////////////////////////////////////////////
/// \file  ParticleListActionT1034.cxx
...
namespace larg4 {
  ...
  int ParticleListActionT1034::fCurrentTrackID = sim::NoParticleId;
  int ParticleListActionT1034::fTrackIDOffset = 0;
  
  //----------------------------------------------------------------------------
  // Dropped particle test
  
  bool ParticleListActionT1034::isDropped(simb::MCParticle const* p) {
    return !p || p->Trajectory().empty();
  } // ParticleListActionT1034::isDropped()
  ...
  //----------------------------------------------------------------------------
  // Destructor.
  ParticleListActionT1034::~ParticleListActionT1034()
  {
  ...
  //----------------------------------------------------------------------------
  // Begin the event
  void ParticleListActionT1034::BeginOfEventAction(const G4Event*)
  {
  ...
  // the fParentIDMap
  int ParticleListActionT1034::GetParentage(int trackid) const
  {
  ...
  void ParticleListActionT1034::PreTrackingAction(const G4Track* track)
  {
    // Particle type.
  ...
  //----------------------------------------------------------------------------
  void ParticleListActionT1034::PostTrackingAction( const G4Track* aTrack)
  {
  ...
  void ParticleListActionT1034::EndOfEventAction(const G4Event*)
  {
  ...
  const sim::ParticleList* ParticleListActionT1034::GetList() const
  {
  ...
  sim::ParticleList&& ParticleListActionT1034::YieldList()
  {
    // check if the ParticleNavigator has entries, and if
    // so grab the highest track id value from it to 
    // add to the fTrackIDOffset
  ...
  } // ParticleList&& ParticleListActionT1034::YieldList()
  
  
  //----------------------------------------------------------------------------
  void ParticleListActionT1034::AddPointToCurrentParticle(TLorentzVector const& pos,
  ...
  } // ParticleListActionT1034::AddPointToCurrentParticle()
