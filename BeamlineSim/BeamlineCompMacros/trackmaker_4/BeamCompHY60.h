...
#ifndef BeamCompHY60SpillSPILLNUM_h
#define BeamCompHY60SpillSPILLNUM_h
...
class BeamCompHY60SpillSPILLNUM	 {
public :
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   BeamCompHY60SpillSPILLNUM(TTree *tree=0);
   virtual ~BeamCompHY60SpillSPILLNUM();
...
#ifdef BeamCompHY60SpillSPILLNUM_cxx
BeamCompHY60SpillSPILLNUM::BeamCompHY60SpillSPILLNUM(TTree *tree) : fChain(0) 
{
...
BeamCompHY60SpillSPILLNUM::~BeamCompHY60SpillSPILLNUM()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t BeamCompHY60SpillSPILLNUM::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t BeamCompHY60SpillSPILLNUM::LoadTree(Long64_t entry)
{
...
void BeamCompHY60SpillSPILLNUM::Init(TTree *tree)
{
...
Bool_t BeamCompHY60SpillSPILLNUM::Notify()
{
...
void BeamCompHY60SpillSPILLNUM::Show(Long64_t entry)
{
...
Int_t BeamCompHY60SpillSPILLNUM::Cut(Long64_t entry)
{
...
#endif // #ifdef BeamCompHY60SpillSPILLNUM_cxx
