#define BeamCompHY60SpillSPILLNUM_cxx
#include "BeamCompHY60SpillSPILLNUM.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
#include <TVector3.h>
...
//Set the B field (T) and L (mm). Always positive.
double B=.2121;
double L=1143.7;
...
void BeamCompHY60SpillSPILLNUM::Loop()
{
...
double BeamCompHY60SpillSPILLNUM::FindTOF(std::vector<double> ushits, std::vector<double> dshits)
{
  int nTOFs=0;
  double TOF=-9999;
...
double BeamCompHY60SpillSPILLNUM::BuildFourPointTrack(std::vector<TVector3> wc1hits, std::vector<TVector3> wc2hits, std::vector<TVector3> wc3hits, std::vector<TVector3> wc4hits)
{
...
double BeamCompHY60SpillSPILLNUM::CalculateFourPointMomentum(int (&wcindex)[4][2], float yslope)
{
...
double BeamCompHY60SpillSPILLNUM::CalculateThreePointMomentum(int (&wcindex)[4][2], float yslope, int WCMissed)
{
  double momentum=0;
  if(WCMissed==2)
  {  
...
void BeamCompHY60SpillSPILLNUM::BuildThreePointTrack(std::vector<TVector3> wc1hits, std::vector<TVector3> wc2hits, std::vector<TVector3> wc3hits, std::vector<TVector3> wc4hits)
{
  std::vector<float> trackstats;
  int WCMissed;
  if(wc2hits.size()==0)
...
//Start here tomorrow.
std::vector<float> BeamCompHY60SpillSPILLNUM::Regression(double (&y)[4], double (&z)[4], int & WCMissed)
{
...
void BeamCompHY60SpillSPILLNUM::ResetVars()
{
  wc1hits.clear();
  wc2hits.clear();
  wc3hits.clear();
...
bool BeamCompHY60SpillSPILLNUM::PassWCFilter(int (&wcindex)[4][2])
{
...
bool BeamCompHY60SpillSPILLNUM::PassWCFilter(int (&wcindex)[4][2], int WCMissed, std::vector<float> trackstats, double momentum)
{
  if(WCMissed==2)
  {
  std::vector<double> WC1Hit={wc1hits[wcindex[0][0]].X(),wc1hits[wcindex[0][1]].Y(),wc1hits[wcindex[0][0]].Z()};
...
std::vector<double> BeamCompHY60SpillSPILLNUM::ProjToZ(std::vector<double> hit0, std::vector<double> hit1, double zpos) {
...
//===================================================================================================
bool BeamCompHY60SpillSPILLNUM::CheckUpstreamMagnetAperture(std::vector<double> hit1, std::vector<double> hit2)
{
...
//MAGNET 2
//===================================================================================================
bool BeamCompHY60SpillSPILLNUM::CheckDownstreamMagnetAperture(std::vector<double> hit1, std::vector<double> hit2)
{
...
//DS Collimator
//===================================================================================================
bool BeamCompHY60SpillSPILLNUM::CheckDownstreamCollimatorAperture(std::vector<double> hit1, std::vector<double> hit2)
{
...
//==================================================================================================================================
bool BeamCompHY60SpillSPILLNUM::MidplaneMatch(std::vector<double> hit1, std::vector<double> hit2, std::vector<double> hit3, std::vector<double> hit4)
{
...
//=============================================================================================================================
bool BeamCompHY60SpillSPILLNUM::MPtoWC4(std::vector<double> hit1, std::vector<double> hit2, std::vector<double> hit3, std::vector<double> hit4)
{
...
bool BeamCompHY60SpillSPILLNUM::PureFrankTrackStatus(int (&ID)[4][2])
{
  int FirstID=ID[0][0];
  for (int i=0; i<4; i++)
  {
...
//======================================================================================================================
bool BeamCompHY60SpillSPILLNUM::PureFrankTrackStatus(int (&ID)[4][2], int WCMissed)
{
 int FirstID=ID[0][0];
  for (int i=0; i<4; i++)
  {
