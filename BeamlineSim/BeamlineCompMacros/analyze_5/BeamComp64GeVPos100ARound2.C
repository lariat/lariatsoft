#define BeamComp64GeVPos100ARound2_cxx
#include "BeamComp64GeVPos100ARound2.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
#include <TRandom3.h>
...
void BeamComp64GeVPos100ARound2::Loop()
{
//Get the data plots
//This could be cleaned up once we have a "production" of beamline reco and a standardized file system.
TFile *fp=new TFile("../../../FinalBeamComp/WCTrackHistosPos100APicky.root"); //Change this your data picky tracks after WCFilter
TH1F *dp=(TH1F*)fp->Get("FourPointMom");
TFile *fh=new TFile("../../../FinalBeamComp/JHoWCTrackHistosPos100.root"); //Change this to your data 3 pt tracks after WCFilt 
TFile *fhy=new TFile("../../../FinalBeamComp/Data100Plots/Pos100A.root");  //File With the TOF and HY tracks
...
double BeamComp64GeVPos100ARound2::FindPDG(double(&pdg)[4][2], double (&mother)[4][2], double (&id)[4][2])
{
  double pdg1=pdg[3][0];
  double pdg2=pdg[3][1];
  double id1=id[3][0];
