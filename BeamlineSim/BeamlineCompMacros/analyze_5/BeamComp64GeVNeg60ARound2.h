...
// found on file: CombinedNeg60Tracks.root
//////////////////////////////////////////////////////////

#ifndef BeamComp64GeVNeg60ARound2_h
#define BeamComp64GeVNeg60ARound2_h
...
class BeamComp64GeVNeg60ARound2 {
public :
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   BeamComp64GeVNeg60ARound2(TTree *tree=0);
   virtual ~BeamComp64GeVNeg60ARound2();
...
#ifdef BeamComp64GeVNeg60ARound2_cxx
BeamComp64GeVNeg60ARound2::BeamComp64GeVNeg60ARound2(TTree *tree) : fChain(0) 
{
...
BeamComp64GeVNeg60ARound2::~BeamComp64GeVNeg60ARound2()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t BeamComp64GeVNeg60ARound2::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t BeamComp64GeVNeg60ARound2::LoadTree(Long64_t entry)
{
...
void BeamComp64GeVNeg60ARound2::Init(TTree *tree)
{
...
Bool_t BeamComp64GeVNeg60ARound2::Notify()
{
...
TPaveText* BeamComp64GeVNeg60ARound2::MakeTextBox(float x, float y, float textSize, float numLines, float width)
{
...
void BeamComp64GeVNeg60ARound2::Show(Long64_t entry)
{
...
Int_t BeamComp64GeVNeg60ARound2::Cut(Long64_t entry)
{
...
#endif // #ifdef BeamComp64GeVNeg60ARound2_cxx
