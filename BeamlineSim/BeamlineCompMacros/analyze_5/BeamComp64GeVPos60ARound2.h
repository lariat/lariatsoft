...
// found on file: CombinedPos60Tracks.root
//////////////////////////////////////////////////////////

#ifndef BeamComp64GeVPos60ARound2_h
#define BeamComp64GeVPos60ARound2_h
...
class BeamComp64GeVPos60ARound2 {
public :
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   BeamComp64GeVPos60ARound2(TTree *tree=0);
   virtual ~BeamComp64GeVPos60ARound2();
...
#ifdef BeamComp64GeVPos60ARound2_cxx
BeamComp64GeVPos60ARound2::BeamComp64GeVPos60ARound2(TTree *tree) : fChain(0) 
{
...
BeamComp64GeVPos60ARound2::~BeamComp64GeVPos60ARound2()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t BeamComp64GeVPos60ARound2::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t BeamComp64GeVPos60ARound2::LoadTree(Long64_t entry)
{
...
void BeamComp64GeVPos60ARound2::Init(TTree *tree)
{
...
Bool_t BeamComp64GeVPos60ARound2::Notify()
{
...
TPaveText* BeamComp64GeVPos60ARound2::MakeTextBox(float x, float y, float textSize, float numLines, float width)
{
...
void BeamComp64GeVPos60ARound2::Show(Long64_t entry)
{
...
Int_t BeamComp64GeVPos60ARound2::Cut(Long64_t entry)
{
...
#endif // #ifdef BeamComp64GeVPos60ARound2_cxx
