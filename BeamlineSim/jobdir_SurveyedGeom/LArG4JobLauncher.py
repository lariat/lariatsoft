...
## 4. With the edited .xml and .fcl, submit a job to the grid to process the text file
##
##
## NOTE:  IT IS UP TO THE USER TO DO SOME PRE-EDITS TO THE XML FILE.
##
## 1. You must edit the "FclDir" in the entities to point to your "JobConfigurations" directory in lariatsoft.  IF NOT: You are going to edit MY version of prodtext_lariat.fcl in my JobConfigurations
...
##
## usage: python LArG4JobLauncher.py /path/to/where/you/have/saved/text/files/
##
...
# Now we get the .fcl file and edit it to use the correct textfile as an input

#  with open(fcldir+"prodtext_lariat.fcl","r") as fclfile:
#    with open(fcldir+"prodtext_lariat_edit.fcl","w") as outfcl:
#      print "In fcl file"
#      for line in fclfile:
#        if line.count("InputFileName")>0:
