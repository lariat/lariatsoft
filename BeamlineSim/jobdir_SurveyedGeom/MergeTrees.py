...
if keepitlocal:
    ...
    outfile = ROOT.TFile("/lariat/data/users/stjohn/MergedAt"+starterTree+infilename,"RECREATE")
...
infile.Close()
if not keepitlocal: commands.getoutput("ln -s /lariat/data/users/stjohn/MergedAt"+starterTree+infilename+" MergedAt"+starterTree+infilename)
print "Here ya go: ",
