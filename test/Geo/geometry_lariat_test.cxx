/**
 * @file   geometry_lariat_test.cxx
 * @brief  Unit test for geometry on LArIAT detector
 * @date   May 11th, 2015
 * @author petrillo@fnal.gov
 * 
 * Usage:
 *   `geometry_lariat_test  [ConfigurationFile [GeometryTestParameterSet]]`
 * 
...
int main(int argc, char const** argv) {
  ...
  LArIATGeometryConfiguration config("geometry_test_lariat");
  ...
  if (nErrors > 0) {
    mf::LogError("geometry_test_lariat") << nErrors << " errors detected!";
  }
